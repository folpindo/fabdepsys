...
abstract class ValidatorAbstract {
    ...
    protected function _checkProcessDefaults(){
        ...
        return $this->_fieldChecker($this->_process_defaults, $this->_params['details']);
    }
    /**
     * 
     * @param type $fields
    ...
    public function fieldChecker($fields, $params){
        return $this->_fieldChecker($fields, $params);
    }
